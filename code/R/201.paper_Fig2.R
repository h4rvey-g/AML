...
paper_macrophage_proportion_change <- function(sc_mye) {
    ...
    # 保存堆叠条形图
    ggsave("results/109.paper/Fig2/macrophage_proportion_stacked.tiff", p1, width = 7, height = 5)
    ...
    # 保存分组条形图
    ggsave("results/109.paper/Fig2/macrophage_proportion_grouped.tiff", p2, width = 7, height = 5)
    ...
    # 保存倍数变化条形图
    ggsave("results/109.paper/Fig2/macrophage_proportion_foldchange.tiff", p3, width = 7, height = 5)
    ...
    # 保存检验结果
    sink("results/109.paper/Fig2/macrophage_proportion_stats.txt")
